...
import com.example.asus.Planner.Activity.MainActivity;
import com.example.asus.Planner.R;

import java.text.DateFormat;
import java.util.Date;

public class DataMessage extends Activity {
    ...
    private void displayListView() {
        ...
        dataAdapter = new SimpleCursorAdapter(this, R.layout.rowmessage, cursor,
                columns, to, 0);
        ...
        listView.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> listView, View view,
                ...
                Intent click = new Intent(DataMessage.this, ViewMessage.class);
    ...
    public void onBackPressed() {
        Intent link = new Intent(DataMessage.this, MainActivity.class);
        startActivity(link);
        finish();
    }
}